...
public class SourceGitMcpToolsTests
{
    [Fact]
    ...
    public void TerminalRead_returns_structured_error_when_output_sharing_is_disabled()
    {
        ...
        var session = CreateSession(@"C:\repo-a");
        registry.Register(session);
        var tools = new SourceGitMcpTools(registry, new SourceGitMcpOptions
        {
    ...
    private static SourceGitMcpTools CreateTools(DevSpaceTerminalRegistry registry)
    {
        return new SourceGitMcpTools(registry, new SourceGitMcpOptions
        {
