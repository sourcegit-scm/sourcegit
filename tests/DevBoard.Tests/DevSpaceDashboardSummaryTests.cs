...
namespace DevBoard.Tests
{
    public sealed class DevSpaceDashboardSummaryTests
    {
        ...
        private sealed class FakeLauncher : DevBoard.DevSpaces.IDevSpaceSessionLauncher
        {
            public DevBoard.DevSpaces.DevSpaceLaunchSpec Create(string terminal, string workingDirectory, string startupCommand = null) =>
